...
<head>
<link REL="stylesheet" TYPE="text/css" HREF="createnewgame.css">
<link REL="shortcut icon" HREF="icon.png">
<title>Snakes & Ladders Online Game - Create New Game</title>
...
<h2 id="p1">Create New Game</h2>

      <form name="form" onsubmit="return validation();" action="CNG_Validation">
	...
	<table align="center"> 
            ...
            <tr>        
                <td align="left"> Number of Players *: </td>
                <td align="left">  
